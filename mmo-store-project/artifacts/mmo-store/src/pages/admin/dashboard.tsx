...
import { LayoutDashboard, Package, FileText, Users, ShoppingCart, Loader2, ArrowUpRight } from "lucide-react";
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
        ...
        <div className="flex gap-2">
          <Button asChild variant="outline">
            <Link href="/admin/san-pham">Quản lý Sản phẩm</Link>
          </Button>
          <Button asChild className="box-glow">
            <Link href="/admin/bai-viet">Quản lý Bài viết</Link>
          </Button>
        </div>
      </div>
