...
import type {
  ...
  ForgotPasswordBody,
  HealthStatus,
  ListBalanceRequests200,
  ListBalanceRequestsParams,
  ListPostsParams,
  ListProductsParams,
  LoginInput,
  MessageResponse,
...
export const getUpdatePostMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updatePost>>, TError,{id: number;data: BodyType<PostInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof updatePost>>, TError,{id: number;data: BodyType<PostInput>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof updatePost>>, {id: number;data: BodyType<PostInput>}> = (props) => {
          const {id,data} = props ?? {};
...
export const getListBalanceRequestsUrl = (params?: ListBalanceRequestsParams,) => {
  const normalizedParams = new URLSearchParams();
  ...
  return stringifiedParams.length > 0 ? `/api/balance-requests?${stringifiedParams}` : `/api/balance-requests`
}

/**
 * @summary List balance requests (admin sees all, user sees own)
 */
export const listBalanceRequests = async (params?: ListBalanceRequestsParams, options?: RequestInit): Promise<ListBalanceRequests200> => {

  return customFetch<ListBalanceRequests200>(getListBalanceRequestsUrl(params),
  {
    ...options,
    method: 'GET'
...
export const getListBalanceRequestsQueryKey = (params?: ListBalanceRequestsParams,) => {
    return [
    `/api/balance-requests`, ...(params ? [params] : [])
    ] as const;
    }


export const getListBalanceRequestsQueryOptions = <TData = Awaited<ReturnType<typeof listBalanceRequests>>, TError = ErrorType<unknown>>(params?: ListBalanceRequestsParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof listBalanceRequests>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getListBalanceRequestsQueryKey(params);



    const queryFn: QueryFunction<Awaited<ReturnType<typeof listBalanceRequests>>> = ({ signal }) => listBalanceRequests(params, { signal, ...requestOptions });





   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof listBalanceRequests>>, TError, TData> & { queryKey: QueryKey }
}

export type ListBalanceRequestsQueryResult = NonNullable<Awaited<ReturnType<typeof listBalanceRequests>>>
export type ListBalanceRequestsQueryError = ErrorType<unknown>
...
export function useListBalanceRequests<TData = Awaited<ReturnType<typeof listBalanceRequests>>, TError = ErrorType<unknown>>(
 params?: ListBalanceRequestsParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof listBalanceRequests>>, TError, TData>, request?: SecondParameter<typeof customFetch>}

 ):  UseQueryResult<TData, TError> & { queryKey: QueryKey } {

  const queryOptions = getListBalanceRequestsQueryOptions(params,options)
...
export const getCreateBalanceRequestUrl = () => {




  return `/api/balance-requests`
}

/**
 * @summary Submit a balance top-up request
 */
export const createBalanceRequest = async (balanceRequestInput: BalanceRequestInput, options?: RequestInit): Promise<BalanceRequest> => {

  return customFetch<BalanceRequest>(getCreateBalanceRequestUrl(),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(balanceRequestInput)
  }
);}
...
export const getCreateBalanceRequestMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createBalanceRequest>>, TError,{data: BodyType<BalanceRequestInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof createBalanceRequest>>, TError,{data: BodyType<BalanceRequestInput>}, TContext> => {

const mutationKey = ['createBalanceRequest'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof createBalanceRequest>>, {data: BodyType<BalanceRequestInput>}> = (props) => {
          const {data} = props ?? {};

          return  createBalanceRequest(data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type CreateBalanceRequestMutationResult = NonNullable<Awaited<ReturnType<typeof createBalanceRequest>>>
    export type CreateBalanceRequestMutationBody = BodyType<BalanceRequestInput>
    export type CreateBalanceRequestMutationError = ErrorType<unknown>

    /**
 * @summary Submit a balance top-up request
 */
export const useCreateBalanceRequest = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createBalanceRequest>>, TError,{data: BodyType<BalanceRequestInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof createBalanceRequest>>,
        TError,
        {data: BodyType<BalanceRequestInput>},
        TContext
      > => {
      return useMutation(getCreateBalanceRequestMutationOptions(options));
    }
...
export const getApproveBalanceRequestUrl = (id: number,) => {
  ...
  return `/api/balance-requests/${id}/approve`
}

/**
 * @summary Approve a balance request (admin)
 */
export const approveBalanceRequest = async (id: number,
    approveBalanceRequestBody?: ApproveBalanceRequestBody, options?: RequestInit): Promise<BalanceRequest> => {

  return customFetch<BalanceRequest>(getApproveBalanceRequestUrl(id),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(approveBalanceRequestBody)
  }
);}
...
export const getApproveBalanceRequestMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof approveBalanceRequest>>, TError,{id: number;data?: BodyType<ApproveBalanceRequestBody>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof approveBalanceRequest>>, TError,{id: number;data?: BodyType<ApproveBalanceRequestBody>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof approveBalanceRequest>>, {id: number;data?: BodyType<ApproveBalanceRequestBody>}> = (props) => {
          const {id,data} = props ?? {};

          return  approveBalanceRequest(id,data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type ApproveBalanceRequestMutationResult = NonNullable<Awaited<ReturnType<typeof approveBalanceRequest>>>
    export type ApproveBalanceRequestMutationBody = BodyType<ApproveBalanceRequestBody> | undefined
    export type ApproveBalanceRequestMutationError = ErrorType<unknown>

    /**
 * @summary Approve a balance request (admin)
 */
export const useApproveBalanceRequest = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof approveBalanceRequest>>, TError,{id: number;data?: BodyType<ApproveBalanceRequestBody>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof approveBalanceRequest>>,
        TError,
        {id: number;data?: BodyType<ApproveBalanceRequestBody>},
        TContext
      > => {
...
export const getRejectBalanceRequestUrl = (id: number,) => {
  ...
  return `/api/balance-requests/${id}/reject`
}

/**
 * @summary Reject a balance request (admin)
 */
export const rejectBalanceRequest = async (id: number,
    rejectBalanceRequestBody?: RejectBalanceRequestBody, options?: RequestInit): Promise<BalanceRequest> => {

  return customFetch<BalanceRequest>(getRejectBalanceRequestUrl(id),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const getRejectBalanceRequestMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof rejectBalanceRequest>>, TError,{id: number;data?: BodyType<RejectBalanceRequestBody>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof rejectBalanceRequest>>, TError,{id: number;data?: BodyType<RejectBalanceRequestBody>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof rejectBalanceRequest>>, {id: number;data?: BodyType<RejectBalanceRequestBody>}> = (props) => {
          const {id,data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type RejectBalanceRequestMutationResult = NonNullable<Awaited<ReturnType<typeof rejectBalanceRequest>>>
    export type RejectBalanceRequestMutationBody = BodyType<RejectBalanceRequestBody> | undefined
    export type RejectBalanceRequestMutationError = ErrorType<unknown>

    /**
 * @summary Reject a balance request (admin)
 */
export const useRejectBalanceRequest = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof rejectBalanceRequest>>, TError,{id: number;data?: BodyType<RejectBalanceRequestBody>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
